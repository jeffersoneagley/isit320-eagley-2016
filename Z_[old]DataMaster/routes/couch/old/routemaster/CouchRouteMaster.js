function CouchRouteMaster(router, nano, dbName, myDbUtilities) {
    ...
    var routerCartography = require('../dbCartography/CouchRouteEditorCartography')(router, nano);
